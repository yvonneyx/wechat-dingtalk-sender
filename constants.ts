export const GITHUB_REQUIRED_REPO = "yvonneyx/wechat-dingtalk-sender"

export const dingGroups = [
  {
    id: 'group-g2-g6-doc',
    name: 'G2、G6 文档完善迫在眉睫',
  ...
  { id: '32183967', name: '蚂蚁集团 - AntV 支持群', accessToken: process.env.TOKEN_32183967 },
  { id: 'group-g2-ant-design-charts', name: 'AntV G2和 Ant Design Charts 技术交流群', accessToken: process.env.TOKEN_group_g2_ant_design_charts },
  { id: '82400003328', name: 'G6 图分析引擎交流群', accessToken: process.env.TOKEN_82400003328 },
